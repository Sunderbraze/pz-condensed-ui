...
function ISCharacterInfoWindow:createChildren()
    ...
    self.panel.equalTabWidth = false;
 	self.panel.allowDraggingTab = true;
 	self.panel.allowDraggingTabs = true;
 	self.panel.allowTornOffTabs = true;
...
function ISCharacterInfoWindow:RestoreLayout(name, layout)
    ...
    if layout.tabs ~= nil then
		...
		floating.info = true
		floating.skills = true
		floating.health = true
		floating.protection = true
        floating.clothingIns = true	end
